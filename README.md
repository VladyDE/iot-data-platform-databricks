...
<ol>
  <li> <span style="color: brown;">Bronze Layer:</span> Incremental ingestion using Auto Loader. It captures file metadata, ingestion timestamps, and handles initial schema inference.</li>
